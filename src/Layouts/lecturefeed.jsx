...
import { LectureGroupFeed } from "../Components/LectureGroupFeed";
// import { Button } from "react-bootstrap";


export const LectureFeed = (props)=>{
            ...
            (isloading)?(
             <Loader />
              ...
              feeds.map((values, key)=>
                ...
                <TimeLineComponent index={key} lecture={true}  len={feeds.length} />       
                <LectureGroupFeed data={values} key={key} course={props.course}/>
                </span>
